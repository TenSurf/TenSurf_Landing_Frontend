...
export const CHART_MENU_ON = {
  label: "ON",
  items: [
    { label: "High and Low of overnight session" },
    { label: "Mid of overnight session" },
  ],
};
...
export const CHART_MENU_PS = {
  label: "PS",
  items: [
    { label: "High and Low of previous RTH session" },
    { label: "Mid of previous RTH session" },
  ],
};
export const CHART_MENU_IB = {
  label: "IB",
  items: [
    { label: "High of initial balance" },
    { label: "Low of initial balance" },
  ],
};
