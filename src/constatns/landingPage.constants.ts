  ...
  items: [
    {
      ...
      description:
        "(TenSurf Brain): Analyze markets, manage risk, and get personalized coaching - all powered by Al.",
    },
    {
      title: "Automated Analysis & Routines",
      description:
        "Streamline your pre-market preparation with a TenSurf Brain that adapts and optimizes your daily routines.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Develop and test trading strategies with ease using natural language prompts.",
    },
    {
...
export const OFFERING_SECTION = {
  ...
  items: [
    ...
    },
    {
      title: "PairSurf",
      description:
        "Providing analytics for identifying and capitalizing on market correlations and divergences.",
...
export const CHART_SECTION = {
  ...
  description:
    "An upcoming user interface upgrade for enhanced trading experience.",
};
  ...
  items: [
    {
      ...
      description:
        "Seamless integration with major trading platforms for streamlined operations.",
      illustration: TradingIntegrationIllustration,
    },
    {
      title: "TradeGPT",
      description:
        "Advanced Large Language Models that can analyze market data and even act on the trader's behalf.",
      illustration: TradeGptIllustration,
    },
    {
      title: "AI Risk Manager",
      description:
        "An AI-driven tool for sophisticated risk analysis and management.",
  ...
  items: [
    {
      ...
      description:
        "TenSurf was founded by a team of industry veterans and technology enthusiasts with a shared vision (empower traders of all levels with the tools and insights needed to thrive in today markets).",
    },
    {
      title: "TenSurf Brain: Your AI Advantage",
      description:
        "We built a cutting-edge trading platform powered by TenSurf Brain, a suite of AI, ML, and data science tools. This translates to sophisticated analytics, robust risk management, and personalized assistance – all designed to elevate your trading experience.",
    },
    {
      title: "Democratizing Trading",
      description:
        "We believe powerful trading tools shouldn be a privilege for the few. TenSurf mission is to level the playing field, providing everyone with the resources they need to succeed.",
    },
  ],
};
...
export const FAQ_SECTION = {
  ...
  description:
    "Sign up for our free trial today and discover the power of TenSurf for yourself!",
  items: [
    {
      question: "1. What is TenSurf?",
      answer:
        "- TenSurf is an innovative trading platform designed to empower both retail traders and professional firms with advanced tools and insights. Our platform leverages cutting-edge AI, ML, and Data Science technologies to streamline trading processes and enhance decision-making.",
    },
    {
      question: "2. Who can benefit from TenSurf?",
      answer:
        "- TenSurf caters to a diverse range of users, including individual retail traders looking to improve their trading performance and professional trading firms seeking advanced analytics and risk management solutions.",
    },
    {
      question: "3. What sets TenSurf apart from other trading platforms?",
      answer:
        "- TenSurf stands out for its sophisticated AI-powered features, including TenSurf Brain, which offers advanced analytics, risk management, personalized assistance, and automation capabilities. Our platform is designed to empower traders with actionable insights and streamline their trading experience.",
    },
    {
      question: "4. How does TenSurf Brain work?",
      answer:
        "- TenSurf Brain is the core engine of our platform, utilizing advanced AI algorithms to analyze market dynamics, provide instant performance feedback, automate routine tasks, and assist with strategy development. It leverages natural language processing to understand user queries and respond with actionable insights.",
    },
    {
      question: "5. Is TenSurf suitable for beginners?",
      answer:
        "- Absolutely! TenSurf is designed to be user-friendly and accessible to traders of all levels. Our platform offers personalized assistance, educational resources, and intuitive tools to help beginners navigate the complexities of trading with confidence.",
    },
    {
      question: "6. Can I customize my trading experience with TenSurf?",
      answer:
        "- Yes, definitely! TenSurf offers customization options to tailor your trading experience to your unique preferences and trading style. Whether you prefer automated strategies, personalized alerts, or specific analytical tools, TenSurf provides the flexibility to meet your needs.",
    },
    {
      question: "7. Is my data safe with TenSurf?",
      answer:
        "- At TenSurf, we prioritize the security and privacy of our users' data. We employ robust encryption protocols and adhere to strict data security standards to ensure your information remains safe and confidential.",
    },
    {
      question: "8. How can I get started with TenSurf?",
      answer:
        "- Getting started with TenSurf is quick and easy! Simply sign up for an account on our website, and you'll gain access to our platform's powerful features and tools. Our user-friendly interface and comprehensive tutorials will guide you through the setup process and help you get up and running in no time.",
    },
    {
      question: "9. Does TenSurf offer customer support?",
      answer:
        "- Yes, TenSurf provides dedicated customer support to assist you with any questions or issues you may encounter. Our team is available to provide timely assistance and ensure you have a seamless experience while using our platform.",
    },
    {
      question: "10. Can I try TenSurf before committing to a subscription?",
      answer:
        "- Absolutely! TenSurf offers a free trial period for new users to explore our platform and experience its features firsthand.",
    },
  ],
};
