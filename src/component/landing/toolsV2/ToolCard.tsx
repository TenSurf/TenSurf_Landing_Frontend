  ...
  return (
    <div
      ...
      <div className="flex gap-4">
        ...
        <h2 className={"font-normal text-xl sm:text-2xl md:text-3xl z-10 text-[#ADB5BD]"}>{title}</h2>
      </div>
      <p className={"text-base sm:text-lg md:text-xl font-normal z-10 text-[#ADB5BD]"}>{description}</p>
    </div>
  );
};
