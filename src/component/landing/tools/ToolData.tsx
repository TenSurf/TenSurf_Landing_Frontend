...
const ToolData = (
  ...
  return (
    <>
      ...
      <p
        ref={descriptionRef}
        className={`cursor-pointer overflow-hidden max-h-[${paragraphHeight ?? 0}px] text-lg font-light mb-2 line-clamp-[8] hover:line-clamp-[40] duration-1000 hover:max-h-[1000px] transition-all`}>{description}</p>
