...
const ToolCard = ({ title, description , className}: { title: string, description: string , className?: string}) => {
  return (
    <div
      className={cn("transition-all duration-500 group hover:scale-[1.03] items-start rounded-3xl bg-[#00041A] w-full flex flex-col justify-center py-8 px-10 gap-6 border-[1px] border-black overflow-hidden z-10 relative after:transition-all after:duration-500 after:contents[''] after:z-0 after:absolute after:inset-0 after:opacity-0 after:bg-gradient-to-r after:from-[#8032FF]/10 from-20% after:to-[#00041A] backdrop-blur-3xl hover:after:opacity-100" , className)}>
