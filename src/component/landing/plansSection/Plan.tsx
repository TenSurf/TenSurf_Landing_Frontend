...
export const Plan: FC<IProps> = ({ plan, isAnnuallyChecked }) => {
  ...
  return (
    <div
      ...
      className={`flex flex-col gap-6 px-8 py-20 border backdrop-blur-[20px]  border-white/2 rounded-3xl relative z-10 w-full lg:w-96`}
    >
      ...
      <Button
        onClick={() => {
          if (plan.is_coming_soon) {
            ...
            router.push(process.env.NEXT_PUBLIC_SIGNIN_URL as string);
          } else {
