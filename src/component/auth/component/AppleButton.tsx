...
export const AppleButton = ({onClick}: {onClick: () => void}) => {
    return (
        <SocialAuthButton onClick={onClick}>
            <svg className={'group-hover:fill-white transition-all fill-gray-600'} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 24 24" xmlSpace="preserve" width="24" height="24">
                <g id="_Group_2">
	                <g id="_Group_3">
